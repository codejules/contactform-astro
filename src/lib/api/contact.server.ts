...
const transporter = nodemailer.createTransport({
  service: 'gmail',
  host: import.meta.env.ASTRO_EMAIL_HOST,
  port: Number(import.meta.env.ASTRO_EMAIL_PORT), // 465 for secure
  secure: import.meta.env.ASTRO_EMAIL_SECURE, // true for 465, false for other ports
  auth: {
